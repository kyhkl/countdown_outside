...
//		else if(__HAL_UART_GET_IT_SOURCE(&uart->huart, USART_IT_IDLE) != RESET)
//		{			
//			uart->huart.Instance->SR;
//			uart->huart.Instance->DR;
//			rt_hw_serial_isr(serial, RT_SERIAL_EVENT_IDLE_RX_IND);
...
int rt_hw_usart_init(void)
{
   ...
   // MX_USART_UART_Init(&uart->huart);
    ...
    rt_hw_serial_register(&serial1, "uart1",
                          ...
                          uart);
//		serial1.parent.open(&serial1.parent,RT_DEVICE_FLAG_RDWR | RT_DEVICE_FLAG_INT_RX);
#endif /* RT_USING_UART1 */
    ...
    rt_hw_serial_register(&serial2, "uart2",
                          ...
                          uart);
//		serial2.parent.open(&serial2.parent,RT_DEVICE_FLAG_RDWR | RT_DEVICE_FLAG_INT_RX);
    ...
    rt_hw_serial_register(&serial3, "uart3",
                          RT_DEVICE_FLAG_RDWR | RT_DEVICE_FLAG_INT_RX,
                          uart);
//		serial3.parent.open(&serial3.parent,RT_DEVICE_FLAG_RDWR | RT_DEVICE_FLAG_INT_RX);
#endif /* RT_USING_UART1 */
    return 0;
}
...
//			 __HAL_UART_ENABLE_IT(uartHandle, USART_IT_IDLE);
        ...
        /* USER CODE BEGIN USART1_MspInit 1 */
				//serial1.parent.open(&serial1.parent,RT_DEVICE_FLAG_INT_RX);
